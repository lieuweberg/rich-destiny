...
var largeImageMap = map[string][]string{
	...
	"ironbanner": {"-1451282428", "-815750908", "-82084646", "1317961215", "1826469369"}, // Iron Banner Control, Iron Banner Clash, Iron Banner Supremacy, Iron Banner Salvage, Iron Banner
	"menagerie": {"400075666"}, // The Menagerie
	"nightmarehunt": {"332181804"}, // Nightmare Hunt
	"privatecrucible": {"-1741423138", "-514207857", "-432922534", "116827562", "122250361", "152599670", "575409284"}, // Private Matches Rumble, - Survival, - Supremacy, - Mayhem, -, - Countdown, - Clash
...
var classImageMap = map[string]string {
	"warlock": "-2023284724",
	"titan": "-639573535",
	"hunter": "671679327",
}